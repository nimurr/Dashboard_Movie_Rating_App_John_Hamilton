          ...
          <div className="w-full px-5 ">
            ...
            >
              ...
              <Form.Item className="w-full">
                <button className="w-full bg-[#1a3c58] text-white p-3 text-xl font-semibold rounded-md">Update Password</button>
              </Form.Item>
            </Form>
          </div>
        )}
        {modelTitle === "Forget password" && (
          <div className="w-full px-5">
            ...
            >
              ...
              <Form.Item>
                <button className="w-full bg-[#1a3c58] text-white p-3 text-xl font-semibold rounded-md">Send verification code</button>
              </Form.Item>
            </Form>
          </div>
        )}
        {modelTitle === "Verify Code" && (
          <div className="px-[60px] pb-[60px] bg-primary">
            <form onSubmit={handleVerifyOtp}>
              ...
              <button className="w-full bg-[#1a3c58] text-white p-3 text-xl font-semibold rounded-md">Verify </button>
            </form>
          </div>
        )}
