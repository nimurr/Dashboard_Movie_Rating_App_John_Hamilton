...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <div className="w-full px-5 py-3.5 bg-[#1a3c58] flex justify-between items-center text-white sticky top-0 left-0 z-10">
      ...
      <div className="flex justify-between items-center gap-5">
        <Link to={"/notification"}>
          <h1 className="relative text-[#1a3c58] p-2 rounded-full bg-white hover:bg-gray-300 hover:text-orange-500">
